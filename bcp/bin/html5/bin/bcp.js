...
Main.prototype = $extend(browser.display.Sprite.prototype,{
	init: function(e) {
		new com.minigloop.Engine(this.get_stage(),com.funbox.bcp.minigame1.screens.PreloaderScreen);
	}
	,__class__: Main
});
...
com.funbox = {}
com.funbox.bcp = {}
com.funbox.bcp.minigame1 = {}
com.funbox.bcp.minigame1.Global = function() {
};
$hxClasses["com.funbox.bcp.minigame1.Global"] = com.funbox.bcp.minigame1.Global;
com.funbox.bcp.minigame1.Global.__name__ = ["com","funbox","bcp","minigame1","Global"];
com.funbox.bcp.minigame1.Global.prototype = {
	__class__: com.funbox.bcp.minigame1.Global
}
com.minigloop = {}
...
com.funbox.bcp.minigame1.MiniGame1 = function(canvas) {
	this._mouseX = 0;
	this._timelapse = 0;
	com.minigloop.Game.call(this,canvas);
	this._canvas.addChild(com.minigloop.util.AssetsLoader.getAsset("background_1"));
	this._enemiesCanvas = new browser.display.Sprite();
	this._canvas.addChild(this._enemiesCanvas);
	this._canvas.addChild(com.minigloop.util.AssetsLoader.getAsset("background_2"));
	var score = com.minigloop.util.AssetsLoader.getAsset("background_score");
	score.set_x(50);
	score.set_y(50);
	this._canvas.addChild(score);
	this._playerCanvas = new browser.display.Sprite();
	this._canvas.addChild(this._playerCanvas);
	this._hotspot = new browser.display.Sprite();
	this._hotspot.get_graphics().beginFill(16777215,0.01);
	this._hotspot.get_graphics().drawRect(0,0,2000,2000);
	this._hotspot.get_graphics().endFill();
	this._canvas.addChild(this._hotspot);
	this._hud = new com.funbox.bcp.minigame1.components.Hud(canvas);
	this._hud.position.x = 50;
	this._hud.position.y = 50;
	this._player = new com.funbox.bcp.minigame1.entities.Player(this._playerCanvas);
	this._enemies = new Array();
	com.funbox.bcp.minigame1.Global.totalLives = 3;
	com.funbox.bcp.minigame1.Global.totalPoints = 0;
	com.funbox.bcp.minigame1.Global.totalTime = 30000;
};
$hxClasses["com.funbox.bcp.minigame1.MiniGame1"] = com.funbox.bcp.minigame1.MiniGame1;
com.funbox.bcp.minigame1.MiniGame1.__name__ = ["com","funbox","bcp","minigame1","MiniGame1"];
com.funbox.bcp.minigame1.MiniGame1.__super__ = com.minigloop.Game;
com.funbox.bcp.minigame1.MiniGame1.prototype = $extend(com.minigloop.Game.prototype,{
	destroy: function() {
	}
	,createEnemy: function() {
		var enemy;
		if(Math.random() > 0.5) enemy = new com.funbox.bcp.minigame1.entities.Virus(this._enemiesCanvas); else enemy = new com.funbox.bcp.minigame1.entities.Black(this._enemiesCanvas);
		enemy.position.y = 40;
		enemy.position.x = 40 + 120 * (Math.random() * 600 / 120 | 0);
		this._enemies.push(enemy);
	}
	,checkCollision: function(r1,r2) {
		var dX = Math.abs(r1.x + r1.width / 2 - (r2.x + r2.width / 2));
		var dY = Math.abs(r1.y + r1.height / 2 - (r2.y + r2.height / 2));
		if(2 * dX <= r1.width + r2.width && 2 * dY <= r1.height + r2.height) return true;
		return false;
	}
	,update: function(dt) {
		...
		this._timelapse += dt;
		if(this._timelapse >= com.funbox.bcp.minigame1.Global.enemyFrequency) {
			this._timelapse = 0;
			this.createEnemy();
		}
		this._player.position.x += (this._mouseX - this._player.position.x) / 4 - 10;
		this._player.position.y = 380;
		if(this._player.position.x <= 40) this._player.position.x = 40;
		if(this._player.position.x >= 550) this._player.position.x = 550;
		var i;
		var _g1 = 0, _g = this._enemies.length - 1;
		while(_g1 < _g) {
			var i1 = _g1++;
			var r1 = this._enemies[i1].collision.getBounds(this._canvas);
			var r2 = this._player.collision.getBounds(this._canvas);
			if(!this._enemies[i1].isHited && this.checkCollision(r1,r2)) {
				this._enemies[i1].onHit();
				this._player.onHit();
				this._hud.setLifes(this._player.numHits);
				com.funbox.bcp.minigame1.Global.totalLives = 3 - this._player.numHits;
				if(this._player.numHits >= 3) this._player.setState("die");
			}
		}
		if(this._player.isDead) {
			...
			com.minigloop.ui.ScreenManager.getInstance().gotoScreen(com.funbox.bcp.minigame1.screens.ScoreCardScreen);
		}
		i = 0;
		var total = this._enemies.length - 1;
		while(i <= total) {
	...
	,__class__: com.funbox.bcp.minigame1.MiniGame1
});
...
com.funbox.bcp.minigame1.components = {}
com.funbox.bcp.minigame1.components.FacebookBar = function() {
	this._speedX = 0;
	this._nFriends = 6;
};
$hxClasses["com.funbox.bcp.minigame1.components.FacebookBar"] = com.funbox.bcp.minigame1.components.FacebookBar;
com.funbox.bcp.minigame1.components.FacebookBar.__name__ = ["com","funbox","bcp","minigame1","components","FacebookBar"];
com.funbox.bcp.minigame1.components.FacebookBar.__super__ = com.minigloop.display.VisualObject;
com.funbox.bcp.minigame1.components.FacebookBar.prototype = $extend(com.minigloop.display.VisualObject.prototype,{
	update: function(dt) {
		var i;
		var _g1 = 0, _g = this._nFriends;
		while(_g1 < _g) {
			var i1 = _g1++;
			this._friends[i1].position.x = 40 + i1 * 95;
			this._friends[i1].position.y = 500;
			this._friends[i1].update(dt);
		}
		this._speedX *= 0.90;
		var _g = this._friendsContainer;
		_g.set_x(_g.get_x() + this._speedX * dt / 30);
		if(this._friendsContainer.get_x() >= 0) this._friendsContainer.set_x(0);
		if(this._friendsContainer.get_x() <= -360) this._friendsContainer.set_x(-360);
	}
	,__class__: com.funbox.bcp.minigame1.components.FacebookBar
});
com.funbox.bcp.minigame1.components.FriendFace = function() { }
$hxClasses["com.funbox.bcp.minigame1.components.FriendFace"] = com.funbox.bcp.minigame1.components.FriendFace;
com.funbox.bcp.minigame1.components.FriendFace.__name__ = ["com","funbox","bcp","minigame1","components","FriendFace"];
com.funbox.bcp.minigame1.components.FriendFace.__super__ = com.minigloop.display.VisualObject;
com.funbox.bcp.minigame1.components.FriendFace.prototype = $extend(com.minigloop.display.VisualObject.prototype,{
	update: function(dt) {
		this._container.set_x(this.position.x);
		this._container.set_y(this.position.y);
	}
	,__class__: com.funbox.bcp.minigame1.components.FriendFace
});
com.funbox.bcp.minigame1.components.Hud = function(canvas) {
	com.minigloop.display.VisualObject.call(this,canvas);
	this._skin = new browser.display.Sprite();
	this._canvas.addChild(this._skin);
	this._tf = new browser.text.TextFormat();
	this._tf.size = 15;
	this._tf.color = 16777215;
	this._tf.bold = true;
	this._tf.font = "calibri";
	this.score = new browser.text.TextField();
	this.score.set_x(75);
	this.score.set_y(3);
	this.score.set_text("00000");
	this.score.setTextFormat(this._tf);
	this.score.set_defaultTextFormat(this._tf);
	this._skin.addChild(this.score);
	this.time = new browser.text.TextField();
	this.time.set_x(210);
	this.time.set_y(3);
	...
	this._life_1.position.x = 600;
	this._life_1.position.y = 3;
	this._life_1.setState("off");
	this._life_1.setState("on");
	this._life_2 = new com.minigloop.display.SpriteEntity(this._canvas);
	this._life_2.addState("on","life_on",null);
	this._life_2.addState("off","life_off",null);
	this._life_2.position.x = 575;
	this._life_2.position.y = 3;
	this._life_2.setState("off");
	this._life_2.setState("on");
	this._life_3 = new com.minigloop.display.SpriteEntity(this._canvas);
	this._life_3.addState("on","life_on",null);
	this._life_3.addState("off","life_off",null);
	this._life_3.position.x = 550;
	this._life_3.position.y = 3;
	this._life_3.setState("off");
	this._life_3.setState("on");
};
$hxClasses["com.funbox.bcp.minigame1.components.Hud"] = com.funbox.bcp.minigame1.components.Hud;
com.funbox.bcp.minigame1.components.Hud.__name__ = ["com","funbox","bcp","minigame1","components","Hud"];
com.funbox.bcp.minigame1.components.Hud.__super__ = com.minigloop.display.VisualObject;
com.funbox.bcp.minigame1.components.Hud.prototype = $extend(com.minigloop.display.VisualObject.prototype,{
	update: function(dt) {
		this._life_1.update(dt);
		this._life_2.update(dt);
		this._life_3.update(dt);
		this._skin.set_x(this.position.x);
		this._skin.set_y(this.position.y);
	}
	,setPoints: function(string) {
		this.score.set_text(string);
		this.score.setTextFormat(this._tf);
	}
	,setTime: function(string) {
		this.time.set_text(string);
		this.time.setTextFormat(this._tf);
	}
	...
	,__class__: com.funbox.bcp.minigame1.components.Hud
});
...
com.minigloop.display.SpriteEntity.prototype = $extend(com.minigloop.display.VisualObject.prototype,{
	...
	,update: function(dt) {
		...
		this.collision.set_x(this.position.x);
		this.collision.set_y(this.position.y);
	...
	,setCollision: function(x,y,width,height) {
		...
		this.collision.get_graphics().beginFill(16777215,0.01);
		this.collision.get_graphics().drawRect(x + width / 2,y + height / 2,width,height);
		this.collision.get_graphics().endFill();
	}
	,__class__: com.minigloop.display.SpriteEntity
});
com.funbox.bcp.minigame1.entities = {}
com.funbox.bcp.minigame1.entities.Enemy = function(canvas) {
	com.minigloop.display.SpriteEntity.call(this,canvas);
};
$hxClasses["com.funbox.bcp.minigame1.entities.Enemy"] = com.funbox.bcp.minigame1.entities.Enemy;
com.funbox.bcp.minigame1.entities.Enemy.__name__ = ["com","funbox","bcp","minigame1","entities","Enemy"];
com.funbox.bcp.minigame1.entities.Enemy.__super__ = com.minigloop.display.SpriteEntity;
com.funbox.bcp.minigame1.entities.Enemy.prototype = $extend(com.minigloop.display.SpriteEntity.prototype,{
	update: function(dt) {
		this.position.y += this._speed * dt / 30;
		if(this.position.y >= 550) this.isDead = true;
		com.minigloop.display.SpriteEntity.prototype.update.call(this,dt);
	}
	,__class__: com.funbox.bcp.minigame1.entities.Enemy
});
com.funbox.bcp.minigame1.entities.Black = function(canvas) {
	com.funbox.bcp.minigame1.entities.Enemy.call(this,canvas);
	this.addState("stand","black","black");
	this.setState("stand");
	this.setCollision(-40,-20,80,40);
	this._speed = Math.random() * com.funbox.bcp.minigame1.Global.minBlackSpeed + com.funbox.bcp.minigame1.Global.maxBlackSpeed;
};
$hxClasses["com.funbox.bcp.minigame1.entities.Black"] = com.funbox.bcp.minigame1.entities.Black;
com.funbox.bcp.minigame1.entities.Black.__name__ = ["com","funbox","bcp","minigame1","entities","Black"];
com.funbox.bcp.minigame1.entities.Black.__super__ = com.funbox.bcp.minigame1.entities.Enemy;
com.funbox.bcp.minigame1.entities.Black.prototype = $extend(com.funbox.bcp.minigame1.entities.Enemy.prototype,{
	__class__: com.funbox.bcp.minigame1.entities.Black
});
com.funbox.bcp.minigame1.entities.Player = function(canvas) {
	com.minigloop.display.SpriteEntity.call(this,canvas);
	this.addState("stand","hand",null);
	this.addState("die","die","die");
	this.addState("hit","hit","hit");
	this.setState("stand");
	this.setCollision(-25,-40,50,80);
};
$hxClasses["com.funbox.bcp.minigame1.entities.Player"] = com.funbox.bcp.minigame1.entities.Player;
com.funbox.bcp.minigame1.entities.Player.__name__ = ["com","funbox","bcp","minigame1","entities","Player"];
com.funbox.bcp.minigame1.entities.Player.__super__ = com.minigloop.display.SpriteEntity;
com.funbox.bcp.minigame1.entities.Player.prototype = $extend(com.minigloop.display.SpriteEntity.prototype,{
	onHit: function() {
		com.minigloop.util.SoundManager.play("hit");
		this.setState("hit");
		com.minigloop.display.SpriteEntity.prototype.onHit.call(this);
	}
	,onEndAnimation: function() {
		switch(this.state) {
		case "die":
	...
	,__class__: com.funbox.bcp.minigame1.entities.Player
});
com.funbox.bcp.minigame1.entities.Virus = function(canvas) {
	com.funbox.bcp.minigame1.entities.Enemy.call(this,canvas);
	this.addState("stand","virus","virus");
	this.setState("stand");
	this.setCollision(-25,-25,60,60);
	this._speed = Math.random() * com.funbox.bcp.minigame1.Global.minVirusSpeed + com.funbox.bcp.minigame1.Global.maxVirusSpeed;
};
$hxClasses["com.funbox.bcp.minigame1.entities.Virus"] = com.funbox.bcp.minigame1.entities.Virus;
com.funbox.bcp.minigame1.entities.Virus.__name__ = ["com","funbox","bcp","minigame1","entities","Virus"];
com.funbox.bcp.minigame1.entities.Virus.__super__ = com.funbox.bcp.minigame1.entities.Enemy;
com.funbox.bcp.minigame1.entities.Virus.prototype = $extend(com.funbox.bcp.minigame1.entities.Enemy.prototype,{
	__class__: com.funbox.bcp.minigame1.entities.Virus
});
com.minigloop.ui = {}
...
com.funbox.bcp.minigame1.screens = {}
com.funbox.bcp.minigame1.screens.GameScreen = function(canvas) {
	com.minigloop.ui.Screen.call(this,canvas);
	var val = 20;
	console.log("GAME SCREEN");
	this._img_1 = com.minigloop.util.AssetsLoader.getAsset("text_1");
	this._img_2 = com.minigloop.util.AssetsLoader.getAsset("text_2");
	this._img_3 = com.minigloop.util.AssetsLoader.getAsset("text_3");
	this._start = com.minigloop.util.AssetsLoader.getAsset("text_start");
	this._game = new com.funbox.bcp.minigame1.MiniGame1(canvas);
	this._game.update(0);
	...
	canvas.addChild(this._img_1);
	canvas.addChild(this._img_2);
	canvas.addChild(this._img_3);
	canvas.addChild(this._start);
	this._state = "tweening";
	this._scaleTweener = new com.funbox.bcp.minigame1.utils.ScaleTweener(this._img_1,$bind(this,this.tween2));
};
$hxClasses["com.funbox.bcp.minigame1.screens.GameScreen"] = com.funbox.bcp.minigame1.screens.GameScreen;
com.funbox.bcp.minigame1.screens.GameScreen.__name__ = ["com","funbox","bcp","minigame1","screens","GameScreen"];
com.funbox.bcp.minigame1.screens.GameScreen.__super__ = com.minigloop.ui.Screen;
com.funbox.bcp.minigame1.screens.GameScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	update: function(dt) {
		switch(this._state) {
		case "tweening":
			...
			break;
		case "init_game":
			com.minigloop.util.SoundManager.play("bgm_1",true);
	...
	,tweenStart: function() {
		this._scaleTweener = new com.funbox.bcp.minigame1.utils.ScaleTweener(this._start,$bind(this,this.endTweens));
	}
	,tween3: function() {
		this._scaleTweener = new com.funbox.bcp.minigame1.utils.ScaleTweener(this._img_3,$bind(this,this.tweenStart));
	}
	,tween2: function() {
		this._scaleTweener = new com.funbox.bcp.minigame1.utils.ScaleTweener(this._img_2,$bind(this,this.tween3));
	}
	,__class__: com.funbox.bcp.minigame1.screens.GameScreen
});
com.funbox.bcp.minigame1.screens.PreloaderScreen = function(canvas) {
	com.minigloop.ui.Screen.call(this,canvas);
	...
	com.minigloop.util.AssetsLoader.addAsset("images/minigame1_guiloader.png","guiloader");
	...
	com.minigloop.util.DataLoader.addData("atlas/minigame1_guiloader.json","guiloader");
...
$hxClasses["com.funbox.bcp.minigame1.screens.PreloaderScreen"] = com.funbox.bcp.minigame1.screens.PreloaderScreen;
com.funbox.bcp.minigame1.screens.PreloaderScreen.__name__ = ["com","funbox","bcp","minigame1","screens","PreloaderScreen"];
com.funbox.bcp.minigame1.screens.PreloaderScreen.__super__ = com.minigloop.ui.Screen;
com.funbox.bcp.minigame1.screens.PreloaderScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	update: function(dt) {
		...
		if(this._isAssetsDownloaded && this._isDataDownloaded && this._isSoundsDownloaded) {
			...
			this.loadas.destroy();
			com.minigloop.ui.ScreenManager.getInstance().gotoScreen(com.funbox.bcp.minigame1.screens.TutorialScreen);
		}
	...
	,onLoadingLoaded: function() {
		...
		this.loadas.position = new com.minigloop.util.Vector2D(270,180);
		com.minigloop.util.AssetsLoader.init();
		com.minigloop.util.AssetsLoader.addAsset("images/minigame1_virus.png","virus");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame1_black.png","black");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame1_hand.png","hand");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame1_hand_hit.png","hit");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame1_explode.png","die");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame1_background_1.jpg","background_1");
		...
		com.minigloop.util.AssetsLoader.addAsset("images/facebookbar/rank_support.png","rank_support");
		com.minigloop.util.AssetsLoader.addAsset("images/facebookbar/button_next_press.png","down");
		com.minigloop.util.AssetsLoader.addAsset("images/facebookbar/button_next_over.png","over");
		com.minigloop.util.AssetsLoader.addAsset("images/facebookbar/button_next_normal.png","up");
		com.minigloop.util.AssetsLoader.addAsset("images/gui_text_01.png","text_3");
		com.minigloop.util.AssetsLoader.addAsset("images/gui_text_02.png","text_2");
		com.minigloop.util.AssetsLoader.addAsset("images/gui_text_03.png","text_1");
		com.minigloop.util.AssetsLoader.addAsset("images/gui_text_start.png","text_start");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame1_life_on.png","life_on");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame1_life_off.png","life_off");
		com.minigloop.util.AssetsLoader.addAsset("images/gui_text_score01.png","score_500");
		com.minigloop.util.AssetsLoader.addAsset("images/gui_text_score02.png","score_1000");
		com.minigloop.util.DataLoader.init();
		com.minigloop.util.DataLoader.addData("atlas/minigame1_virus.json","virus");
		com.minigloop.util.DataLoader.addData("atlas/minigame1_black.json","black");
		com.minigloop.util.DataLoader.addData("atlas/minigame1_explode.json","die");
		com.minigloop.util.DataLoader.addData("atlas/minigame1_hand_hit.json","hit");
		com.minigloop.util.SoundManager.init();
		com.minigloop.util.SoundManager.addSound("sound/pts.mp3","points");
		com.minigloop.util.SoundManager.addSound("sound/scorecard.mp3","scorecard");
		com.minigloop.util.SoundManager.addSound("sound/hit.mp3","hit");
		com.minigloop.util.SoundManager.addSound("sound/bgm_1.mp3","bgm_1");
	...
	,__class__: com.funbox.bcp.minigame1.screens.PreloaderScreen
});
com.funbox.bcp.minigame1.screens.ScoreCardScreen = function(canvas) {
	com.minigloop.ui.Screen.call(this,canvas);
	...
	this._message.set_text("Hiciste " + com.funbox.bcp.minigame1.Global.totalPoints + " puntos mientras practicabas para prevenir este fraude.");
...
com.funbox.bcp.minigame1.screens.ScoreCardScreen.__super__ = com.minigloop.ui.Screen;
com.funbox.bcp.minigame1.screens.ScoreCardScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	destroy: function() {
...
com.funbox.bcp.minigame1.screens.TutorialScreen = function(canvas) {
	this._t = 0;
	com.minigloop.ui.Screen.call(this,canvas);
...
com.funbox.bcp.minigame1.screens.TutorialScreen.__super__ = com.minigloop.ui.Screen;
com.funbox.bcp.minigame1.screens.TutorialScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	update: function(dt) {
...
$hxClasses["com.funbox.bcp.minigame1.utils.ScaleTweener"] = com.funbox.bcp.minigame1.utils.ScaleTweener;
com.funbox.bcp.minigame1.utils.ScaleTweener.__name__ = ["com","funbox","bcp","minigame1","utils","ScaleTweener"];
com.funbox.bcp.minigame1.utils.ScaleTweener.prototype = {
	update: function(dt) {
		if(this._isPaused) return;
	...
	,__class__: com.funbox.bcp.minigame1.utils.ScaleTweener
}
...
com.minigloop.display.Button = function() { }
...
com.funbox.bcp.minigame1.Global.minBlackSpeed = 3;
com.funbox.bcp.minigame1.Global.maxBlackSpeed = 3;
com.funbox.bcp.minigame1.Global.minVirusSpeed = 5;
com.funbox.bcp.minigame1.Global.maxVirusSpeed = 5;
com.funbox.bcp.minigame1.Global.enemyFrequency = 1000;
com.funbox.bcp.minigame1.Global.totalPoints = 0;
com.funbox.bcp.minigame1.Global.totalTime = 5000;
com.funbox.bcp.minigame1.Global.totalLives = 3;
