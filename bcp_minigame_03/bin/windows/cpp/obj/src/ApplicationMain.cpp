...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(15)
		::nme::Lib_obj::setPackage(HX_CSTRING(""),HX_CSTRING("bcp"),HX_CSTRING("com.bcp"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(39)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)640,(int)30,(int)0,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("bcp"),null());
	}
return null();
}
