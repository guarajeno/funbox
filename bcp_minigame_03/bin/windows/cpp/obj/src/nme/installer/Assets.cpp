...
bool useCache = __o_useCache.Default(true);
	HX_STACK_PUSH("Assets::getBitmapData","nme/installer/Assets.hx",52);
	HX_STACK_ARG(id,"id");
		...
		if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id)->__Field(HX_CSTRING("toLowerCase"),true)() == HX_CSTRING("image")))))){
			...
			if (((id.indexOf(HX_CSTRING(":"),null()) > (int)-1))){
				...
				if ((::nme::installer::Assets_obj::libraryTypes->exists(libraryName))){
					...
					HX_STACK_LINE(115)
					::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),117,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBitmapData")));
				}
			}
			else{
				HX_STACK_LINE(121)
				::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no BitmapData asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),123,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBitmapData")));
			}
		}
		HX_STACK_LINE(127)
		return null();
...
::native::utils::ByteArray Assets_obj::getBytes( ::String id){
	HX_STACK_PUSH("Assets::getBytes","nme/installer/Assets.hx",132);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(134)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(136)
	if ((::nme::installer::Assets_obj::resourceNames->exists(id))){
		...
		HX_STACK_LINE(142)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no String or ByteArray asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),142,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBytes")));
		HX_STACK_LINE(144)
		return null();
	}
	HX_STACK_LINE(136)
...
::native::text::Font Assets_obj::getFont( ::String id){
	HX_STACK_PUSH("Assets::getFont","nme/installer/Assets.hx",151);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(153)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(155)
	if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id)->__Field(HX_CSTRING("toLowerCase"),true)() == HX_CSTRING("font")))))){
		...
		HX_STACK_LINE(161)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Font asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),161,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getFont")));
		HX_STACK_LINE(163)
		return null();
	}
	HX_STACK_LINE(155)
...
::format::display::MovieClip Assets_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("Assets::getMovieClip","nme/installer/Assets.hx",170);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(172)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(174)
	...
	if ((::nme::installer::Assets_obj::libraryTypes->exists(libraryName))){
		...
		HX_STACK_LINE(211)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),213,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getMovieClip")));
	}
	HX_STACK_LINE(217)
	return null();
}
...
::String Assets_obj::getResourceName( ::String id){
	HX_STACK_PUSH("Assets::getResourceName","nme/installer/Assets.hx",222);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(224)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(226)
...
::native::media::Sound Assets_obj::getSound( ::String id){
	HX_STACK_PUSH("Assets::getSound","nme/installer/Assets.hx",231);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(233)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(235)
	...
	HX_STACK_LINE(249)
	::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Sound asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),249,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getSound")));
	HX_STACK_LINE(251)
	return null();
}
...
::String Assets_obj::getText( ::String id){
	HX_STACK_PUSH("Assets::getText","nme/installer/Assets.hx",256);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(258)
