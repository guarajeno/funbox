...
{
		HX_STACK_PUSH("Gc::enable","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",6);
...
{
		HX_STACK_PUSH("Gc::run","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",11);
...
Void Gc_obj::compact( ){
{
		HX_STACK_PUSH("Gc::compact","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",16);
		HX_STACK_LINE(16)
		::__hxcpp_gc_compact();
	}
return null();
...
int Gc_obj::memUsage( ){
	HX_STACK_PUSH("Gc::memUsage","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",21);
	HX_STACK_LINE(21)
...
bool printInstances = __o_printInstances.Default(true);
	HX_STACK_PUSH("Gc::trace","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",26);
...
bool Gc_obj::versionCheck( ){
	HX_STACK_PUSH("Gc::versionCheck","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",30);
	HX_STACK_LINE(30)
	return true;
}
...
{
		HX_STACK_PUSH("Gc::doNotKill","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",33);
...
Dynamic Gc_obj::getNextZombie( ){
	HX_STACK_PUSH("Gc::getNextZombie","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",38);
	HX_STACK_LINE(38)
...
{
		HX_STACK_PUSH("Gc::safePoint","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",43);
		HX_STACK_LINE(43)
...
{
		HX_STACK_PUSH("Gc::enterGCFreeZone","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",48);
		HX_STACK_LINE(48)
...
{
		HX_STACK_PUSH("Gc::exitGCFreeZone","C:\\Motion-Twin\\haxe/std/cpp/vm/Gc.hx",53);
		HX_STACK_LINE(53)
