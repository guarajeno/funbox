...
import com.funbox.bcp.minigame2.util.ScaleTweener;
...
class GameTransitionPopupScreen
{
	...
	public function new(canvas:Sprite, onCallbackFunction:Dynamic) {
		...
		_img_1 = NUtils.getAsset("spMinigame02_gui_text_03");
		_img_2 = NUtils.getAsset("spMinigame02_gui_text_02");
		_img_3 = NUtils.getAsset("spMinigame02_gui_text_01");
		_start = NUtils.getAsset("spMinigame02_gui_text_start");
