...
com.funbox.ania.component.MenuBar = function(canvas) {
	...
	this._background.set_x(5);
	this._background.set_y(-100);
	this._canvas.addChild(this._background);
	this._btnEpisodes = new com.minigloop.display.Button(canvas,"web_common_button_episodes_normal","web_common_button_episodes_over","web_common_button_episodes_over",$bind(this,this._onEpisodes_Click));
	this._btnEpisodes.position.x = 100;
	this._btnEpisodes.position.y = 100;
};
...
com.funbox.ania.screen.PreloaderScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	update: function(dt) {
		if(this._isAssetsDownloaded && this._isDataDownloaded && this._isSoundsDownloaded) com.minigloop.ui.ScreenManager.getInstance().gotoScreen(com.funbox.ania.screen.HomeScreen);
...
com.minigloop.display.Button = function(canvas,upId,overId,downId,_callback) {
	...
	this.setState("down");
	this.setState("up");
	this.setCollision(-20,-20,40,40);
	this.collision.buttonMode = true;
	this.collision.addEventListener(browser.events.MouseEvent.MOUSE_DOWN,$bind(this,this.onDown));
	this.collision.addEventListener(browser.events.MouseEvent.MOUSE_OVER,$bind(this,this.onOver));
	this.collision.addEventListener(browser.events.MouseEvent.MOUSE_OUT,$bind(this,this.onOut));
	this.collision.addEventListener(browser.events.MouseEvent.MOUSE_UP,$bind(this,this.onOut));
};
