...
import com.funbox.bcp.minigame4.util.ScaleTweener;
...
class GameTransitionPopupScreen
{
	...
	public function new(canvas:Sprite, onCallbackFunction:Dynamic) {
		...
		_img_1 = NUtils.getAsset("spminigame04_gui_text_03");
		_img_2 = NUtils.getAsset("spminigame04_gui_text_02");
		_img_3 = NUtils.getAsset("spminigame04_gui_text_01");
		_start = NUtils.getAsset("spminigame04_gui_text_start");
