package com.funbox.bcp.minigame4;

import com.funbox.bcp.minigame4.engine.VerticalTouchEngine;
import com.funbox.bcp.minigame4.entities.BaseActor;
import com.funbox.bcp.minigame4.screens.GameHud;
import com.funbox.bcp.minigame4.screens.ScoreCardScreen;
...
class MiniGame2 extends Game {
	...
	private var mOnMouseClickCallback:Dynamic;
	...
	public function setMouseCallbacks(onMouseClick:Dynamic = null):Void {
		mOnMouseClickCallback = onMouseClick;
	}
	...
	private function onMouseHandler(e:MouseEvent):Void {
		...
		case MouseEvent.MOUSE_UP:
			if (mMousePressed) {
				if (mOnMouseClickCallback != null) {
					mOnMouseClickCallback();
				}
			}
