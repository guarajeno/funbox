...
Main.prototype = $extend(browser.display.Sprite.prototype,{
	init: function(e) {
		new com.minigloop.Engine(this.get_stage(),com.funbox.bcp.minigame4.screens.PreloaderScreen);
	}
	,__class__: Main
});
...
com.funbox = {}
com.funbox.bcp = {}
com.funbox.bcp.minigame4 = {}
com.funbox.bcp.minigame4.Global = function() {
};
$hxClasses["com.funbox.bcp.minigame4.Global"] = com.funbox.bcp.minigame4.Global;
com.funbox.bcp.minigame4.Global.__name__ = ["com","funbox","bcp","minigame4","Global"];
com.funbox.bcp.minigame4.Global.prototype = {
	__class__: com.funbox.bcp.minigame4.Global
}
com.minigloop = {}
...
$hxClasses["com.minigloop.Game"] = com.minigloop.Game;
com.minigloop.Game.__name__ = ["com","minigloop","Game"];
com.minigloop.Game.prototype = {
	destroy: function() {
	}
	,update: function(dt) {
	}
...
com.funbox.bcp.minigame4.MiniGame2 = function(canvas,gameHud) {
	com.minigloop.Game.call(this,canvas);
	com.funbox.bcp.minigame4.Global.minigame = this;
	this.mGameHud = gameHud;
	this.mMouseX = 0;
	this.mMouseY = 0;
	this.mLevelTime = 60100;
	...
	this.mGhostGameMask.addEventListener(browser.events.MouseEvent.MOUSE_MOVE,$bind(this,this.onMouseHandler));
	this.mGhostGameMask.addEventListener(browser.events.MouseEvent.MOUSE_DOWN,$bind(this,this.onMouseHandler));
	this.mGhostGameMask.addEventListener(browser.events.MouseEvent.MOUSE_UP,$bind(this,this.onMouseHandler));
	this.mGhostGameMask.addEventListener(browser.events.MouseEvent.MOUSE_OUT,$bind(this,this.onMouseHandler));
	...
	this.mVTEngine = new com.funbox.bcp.minigame4.engine.VerticalTouchEngine(this,this.mGameCanvas);
	com.funbox.bcp.minigame4.Global.stage.addChild(this.mGhostGameMask);
};
$hxClasses["com.funbox.bcp.minigame4.MiniGame2"] = com.funbox.bcp.minigame4.MiniGame2;
com.funbox.bcp.minigame4.MiniGame2.__name__ = ["com","funbox","bcp","minigame4","MiniGame2"];
com.funbox.bcp.minigame4.MiniGame2.__super__ = com.minigloop.Game;
com.funbox.bcp.minigame4.MiniGame2.prototype = $extend(com.minigloop.Game.prototype,{
	destroy: function() {
		this.mVTEngine.free();
		this.mVTEngine = null;
		com.funbox.bcp.minigame4.Global.stage.removeChild(this.mGhostGameMask);
		this.mGhostGameMask = null;
		this._canvas.removeChild(this.mGameCanvas);
		this.mGameCanvas = null;
		com.minigloop.Game.prototype.destroy.call(this);
	}
	,update: function(dt) {
		...
		if(!this.mOnEndGame) {
			...
			if(this.mLevelTime <= 0) {
				...
				com.funbox.bcp.minigame4.Global.totalPoints = this.mGameHud.GetScore();
				com.minigloop.ui.ScreenManager.getInstance().gotoScreen(com.funbox.bcp.minigame4.screens.ScoreCardScreen);
	...
	,onMouseHandler: function(e) {
		...
		case browser.events.MouseEvent.MOUSE_UP:
			if(this.mMousePressed) {
				if(this.mOnMouseClickCallback != null) this.mOnMouseClickCallback();
			}
			this.mMousePressed = false;
			break;
	...
	,setMouseCallbacks: function(onMouseClick) {
		this.mOnMouseClickCallback = onMouseClick;
	}
	,getGameHud: function() {
		return this.mGameHud;
	}
	,__class__: com.funbox.bcp.minigame4.MiniGame2
});
com.funbox.bcp.minigame4.engine = {}
com.funbox.bcp.minigame4.engine.PullAndPushController = function(player,mosaicosGroup,gameCard,parentCanvas) {
	this.mPlayerRef = player;
	this.mGameCardRef = gameCard;
	this.mMosaicosGroupRef = mosaicosGroup;
	this.mParentCanvas = parentCanvas;
	this.mComboFactor = 1;
	this.mComboFactorPercentage = 0.32;
	this.mMouseClickWave_1 = 20;
	this.mMouseClickWave_2 = 40;
	this.mMouseClickWave_3 = 60;
	this.mCurrentWave = com.funbox.bcp.minigame4.engine.PullAndPushController.WAVE_1;
	this.mOldIndex = -1;
	this.mSinFactor = 0;
	this.mPullFactor = 15;
...
$hxClasses["com.funbox.bcp.minigame4.engine.PullAndPushController"] = com.funbox.bcp.minigame4.engine.PullAndPushController;
com.funbox.bcp.minigame4.engine.PullAndPushController.__name__ = ["com","funbox","bcp","minigame4","engine","PullAndPushController"];
com.funbox.bcp.minigame4.engine.PullAndPushController.prototype = {
	free: function() {
		this.mPlayerRef = null;
		this.mMosaicosGroupRef = null;
		this.mMouseInterval = null;
		this.mComboScoreInterval = null;
	}
	,update: function(dt) {
		if(this.mInterval != null) this.mInterval.update(dt);
		if(this.mMouseInterval != null) this.mMouseInterval.update(dt);
	...
	,onMouseClick: function() {
		...
		if(!isPausedGame) {
			this.mCurrentClicks++;
			if(this.mComboScoreInterval == null) {
				this.mComboFactor = 1;
				this.mComboScoreInterval = new com.funbox.bcp.minigame4.util.NInterval($bind(this,this.onEndComboScoreInterval),180);
			} else {
				this.mComboFactor++;
				this.mComboScoreInterval = new com.funbox.bcp.minigame4.util.NInterval($bind(this,this.onEndComboScoreInterval),180);
			}
			switch(this.mCurrentWave) {
			case com.funbox.bcp.minigame4.engine.PullAndPushController.WAVE_1:
				if(this.mCurrentClicks >= this.mMouseClickWave_1) {
					this.mCurrentClicks = 0;
					this.mPullFactor += 5;
					this.mCurrentWave = com.funbox.bcp.minigame4.engine.PullAndPushController.WAVE_2;
					this.mMosaicosGroupRef.appearNextMosaico();
				}
				break;
			case com.funbox.bcp.minigame4.engine.PullAndPushController.WAVE_2:
				if(this.mCurrentClicks >= this.mMouseClickWave_2) {
					this.mCurrentClicks = 0;
					this.mPullFactor += 5;
					this.mCurrentWave = com.funbox.bcp.minigame4.engine.PullAndPushController.WAVE_3;
					this.mMosaicosGroupRef.appearNextMosaico();
				}
				break;
			...
			if(this.mMouseInterval == null) {
				this.mDoPushEnemies = false;
				this.mMouseInterval = new com.funbox.bcp.minigame4.util.NInterval($bind(this,this.onMouseIntervalFinish),150);
			}
			var score_normal = 20;
			var score_multiplier = 1 + this.mComboFactor * this.mComboFactorPercentage;
			var score_final = score_normal * score_multiplier;
			com.funbox.bcp.minigame4.Global.minigame.getGameHud().SetScore(com.funbox.bcp.minigame4.Global.minigame.getGameHud().GetScore() + (score_final | 0));
		}
	}
	,onEndComboScoreInterval: function() {
		this.mComboScoreInterval.free();
		this.mComboScoreInterval = null;
		this.mComboFactor = 1;
	}
	...
	,onEndInterval: function() {
		...
		if(this.mDoPushEnemies) {
			...
			this.mMosaicosGroupRef.gotoState(com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.ST_WALK_RIGHT);
			this.mGameCardRef.gotoState(com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.ST_WALK_RIGHT);
			var _g = this.mParentCanvas;
			_g.set_x(_g.get_x() + this.mPullFactor);
			if(this.mParentCanvas.get_x() >= 375) com.funbox.bcp.minigame4.Global.minigame.onEndGame();
		} else {
			this.mPlayerRef.gotoState("spMinigame04_player_walk_left");
	...
	,__class__: com.funbox.bcp.minigame4.engine.PullAndPushController
}
com.funbox.bcp.minigame4.engine.VerticalTouchEngine = function(miniGameRef,gameCanvas) {
	...
	this.mMosaicosCanvas = new browser.display.Sprite();
	this.mCardCanvas = new browser.display.Sprite();
	this.mGameEverythingCanvas = new browser.display.Sprite();
	this.mEffectScoreCanvas = new browser.display.Sprite();
	this.mGameCanvas.addChild(this.mBGCanvas);
	this.mGameCanvas.addChild(this.mGameEverythingCanvas);
	this.mGameCanvas.addChild(this.mEffectScoreCanvas);
	this.mGameEverythingCanvas.addChild(this.mCardCanvas);
	this.mGameEverythingCanvas.addChild(this.mMosaicosCanvas);
	this.mGameEverythingCanvas.addChild(this.mPlayerCanvas);
...
$hxClasses["com.funbox.bcp.minigame4.engine.VerticalTouchEngine"] = com.funbox.bcp.minigame4.engine.VerticalTouchEngine;
com.funbox.bcp.minigame4.engine.VerticalTouchEngine.__name__ = ["com","funbox","bcp","minigame4","engine","VerticalTouchEngine"];
com.funbox.bcp.minigame4.engine.VerticalTouchEngine.prototype = {
	free: function() {
		this.mEffectManager.free();
		this.mEffectManagerScore.free();
		this.mBGSprite.free();
		this.mBGMaskSprite.free();
		this.mPlayer.free();
		this.mMosaicosGroup.free();
		this.mPullAndPushController.free();
		this.mGameCard.free();
		this.mEffectManagerScore = null;
		this.mPullAndPushController = null;
		this.mMosaicosGroup = null;
		this.mBGSprite = null;
		...
		this.mGameCanvas.removeChild(this.mGameEverythingCanvas);
		this.mGameCanvas.removeChild(this.mEffectScoreCanvas);
		this.mGameEverythingCanvas.removeChild(this.mCardCanvas);
		this.mGameEverythingCanvas.removeChild(this.mMosaicosCanvas);
		this.mGameEverythingCanvas.removeChild(this.mPlayerCanvas);
		this.mGameEverythingCanvas.removeChild(this.mEffectCanvas);
		this.mBGCanvas = null;
		this.mPlayerCanvas = null;
		this.mEffectCanvas = null;
		this.mCardCanvas = null;
		this.mMosaicosCanvas = null;
		this.mEffectScoreCanvas = null;
		this.mGameEverythingCanvas = null;
	}
	,update: function(dt) {
		this.mPlayer.update(dt);
		this.mMosaicosGroup.update(dt);
		this.mPullAndPushController.update(dt);
		this.mGameCard.update(dt);
		this.mEffectManager.update(dt);
		this.mEffectManagerScore.update(dt);
		this.mBGSprite.update(dt);
		this.mBGMaskSprite.update(dt);
	}
	,__class__: com.funbox.bcp.minigame4.engine.VerticalTouchEngine
}
com.funbox.bcp.minigame4.entities = {}
com.funbox.bcp.minigame4.entities.BaseActor = function(clipName,aniData,canvas,x,y) {
	this.mX = x;
	this.mY = y;
	this.mCanvas = canvas;
	this.mOffsetX = 0;
	...
	if(clipName != null && aniData == null) {
		this.mStaticImage = true;
		this.mBitmap = com.funbox.bcp.minigame4.util.NUtils.getAsset(clipName);
		...
		this.mCharacter = new com.funbox.bcp.minigame4.util.NCharacter(this.mCanvas);
...
$hxClasses["com.funbox.bcp.minigame4.entities.BaseActor"] = com.funbox.bcp.minigame4.entities.BaseActor;
com.funbox.bcp.minigame4.entities.BaseActor.__name__ = ["com","funbox","bcp","minigame4","entities","BaseActor"];
com.funbox.bcp.minigame4.entities.BaseActor.prototype = {
	free: function() {
	...
	,__class__: com.funbox.bcp.minigame4.entities.BaseActor
}
com.funbox.bcp.minigame4.engine.effectManager = {}
com.funbox.bcp.minigame4.engine.effectManager.BaseEffect = function(clipName,aniData,canvas,x,y) {
	com.funbox.bcp.minigame4.entities.BaseActor.call(this,clipName,aniData,canvas,x,y);
	this.isDead = false;
...
$hxClasses["com.funbox.bcp.minigame4.engine.effectManager.BaseEffect"] = com.funbox.bcp.minigame4.engine.effectManager.BaseEffect;
com.funbox.bcp.minigame4.engine.effectManager.BaseEffect.__name__ = ["com","funbox","bcp","minigame4","engine","effectManager","BaseEffect"];
com.funbox.bcp.minigame4.engine.effectManager.BaseEffect.__super__ = com.funbox.bcp.minigame4.entities.BaseActor;
com.funbox.bcp.minigame4.engine.effectManager.BaseEffect.prototype = $extend(com.funbox.bcp.minigame4.entities.BaseActor.prototype,{
	update: function(dt) {
		...
		if(!this.isDead) com.funbox.bcp.minigame4.entities.BaseActor.prototype.update.call(this,dt);
	}
	,__class__: com.funbox.bcp.minigame4.engine.effectManager.BaseEffect
});
com.funbox.bcp.minigame4.engine.effectManager.EffectManager = function(canvas) {
	this.mCanvas = canvas;
	this.mEffectsRepo = new Array();
};
$hxClasses["com.funbox.bcp.minigame4.engine.effectManager.EffectManager"] = com.funbox.bcp.minigame4.engine.effectManager.EffectManager;
com.funbox.bcp.minigame4.engine.effectManager.EffectManager.__name__ = ["com","funbox","bcp","minigame4","engine","effectManager","EffectManager"];
com.funbox.bcp.minigame4.engine.effectManager.EffectManager.prototype = {
	free: function() {
		var i = 0;
	...
	,update: function(dt) {
		...
		while(i <= length) {
			var sObj = this.mEffectsRepo[i];
			if(sObj != null) {
				if(!sObj.isDead) sObj.update(dt); else {
					sObj.free();
					sObj = null;
					this.mEffectsRepo.splice(i,1);
					length--;
	...
	,createEffect: function(x,y,clipName,aniData) {
		var touchObj = null;
		touchObj = new com.funbox.bcp.minigame4.engine.effectManager.BaseEffect(clipName,aniData,this.mCanvas,x,y);
		if(touchObj != null) this.mEffectsRepo.push(touchObj);
		return touchObj;
	}
	,__class__: com.funbox.bcp.minigame4.engine.effectManager.EffectManager
}
com.funbox.bcp.minigame4.engine.effectManager.SpriteAndTextEffect = function() { }
$hxClasses["com.funbox.bcp.minigame4.engine.effectManager.SpriteAndTextEffect"] = com.funbox.bcp.minigame4.engine.effectManager.SpriteAndTextEffect;
com.funbox.bcp.minigame4.engine.effectManager.SpriteAndTextEffect.__name__ = ["com","funbox","bcp","minigame4","engine","effectManager","SpriteAndTextEffect"];
com.funbox.bcp.minigame4.engine.effectManager.SpriteAndTextEffect.__super__ = com.funbox.bcp.minigame4.engine.effectManager.BaseEffect;
com.funbox.bcp.minigame4.engine.effectManager.SpriteAndTextEffect.prototype = $extend(com.funbox.bcp.minigame4.engine.effectManager.BaseEffect.prototype,{
	free: function() {
		...
		com.funbox.bcp.minigame4.engine.effectManager.BaseEffect.prototype.free.call(this);
	}
	,update: function(dt) {
		...
		com.funbox.bcp.minigame4.engine.effectManager.BaseEffect.prototype.update.call(this,dt);
		if(aniEndStartAlpha) this.mAniEndStartAlpha = true;
	}
	,__class__: com.funbox.bcp.minigame4.engine.effectManager.SpriteAndTextEffect
});
com.funbox.bcp.minigame4.entities.card = {}
com.funbox.bcp.minigame4.entities.card.GameCard = function(canvas,x,y,offsetX,offsetY) {
	if(offsetY == null) offsetY = 0;
	if(offsetX == null) offsetX = 0;
	com.funbox.bcp.minigame4.entities.BaseActor.call(this,"spMinigame04_bcp_card",null,canvas,x,y);
	this.mCurrentState = -1;
	this.mBitmap.set_scaleX(this.mBitmap.set_scaleY(0.5));
	this.mCardInitX = this.getX();
};
$hxClasses["com.funbox.bcp.minigame4.entities.card.GameCard"] = com.funbox.bcp.minigame4.entities.card.GameCard;
com.funbox.bcp.minigame4.entities.card.GameCard.__name__ = ["com","funbox","bcp","minigame4","entities","card","GameCard"];
...
com.funbox.bcp.minigame4.entities.card.GameCard.prototype = $extend(com.funbox.bcp.minigame4.entities.BaseActor.prototype,{
	update: function(dt) {
		...
		case com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.ST_WALK_RIGHT:
			atlas = this.mPlayerRef.getCharacter().currentAnimation();
			currentIndex = atlas.getCurrentIndex();
			maxIndex = atlas.getLength();
			if(this.mCurrentAnimationPlayer != atlas) {
				this.mCurrentState = -1;
			...
			break;
		case com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.ST_WALK_LEFT:
			atlas = this.mPlayerRef.getCharacter().currentAnimation();
			currentIndex = atlas.getCurrentIndex();
			maxIndex = atlas.getLength();
			if(this.mCurrentAnimationPlayer != atlas) {
	...
	,gotoState: function(state) {
		...
		this.mCurrentAnimationPlayer = this.mPlayerRef.getCharacter().currentAnimation();
	}
	,__class__: com.funbox.bcp.minigame4.entities.card.GameCard
});
com.funbox.bcp.minigame4.entities.enemy = {}
com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup = function(canvas,x,y,effectManager) {
	this.mX = x;
	this.mY = y;
	this.mCanvas = canvas;
	this.mEffectManager = effectManager;
	this.mMosaicoCanvas_1 = new browser.display.Sprite();
	this.mMosaicoCanvas_2 = new browser.display.Sprite();
	this.mMosaicoCanvas_3 = new browser.display.Sprite();
	this.mCanvas.addChild(this.mMosaicoCanvas_1);
	this.mCanvas.addChild(this.mMosaicoCanvas_2);
	this.mCanvas.addChild(this.mMosaicoCanvas_3);
	this.mMosaico_1 = new com.funbox.bcp.minigame4.entities.BaseActor("spMinigame04_mosaico_1_stand","spMinigame04_mosaico_1_stand",this.mMosaicoCanvas_3,this.mX,this.mY);
	this.mMosaico_1.getCharacter().addState("spMinigame04_mosaico_1_walk_left","spMinigame04_mosaico_1_walk_left","spMinigame04_mosaico_1_walk_left",-4,-7);
	this.mMosaico_1.getCharacter().addState("spMinigame04_mosaico_1_walk_right","spMinigame04_mosaico_1_walk_right","spMinigame04_mosaico_1_walk_right",7,-7);
	this.mMosaico_1.getCharacter().onEndAnimationCallback($bind(this,this.onEndAnimationMosaico_1));
	this.mMosaicoCount = 1;
};
$hxClasses["com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup"] = com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup;
com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.__name__ = ["com","funbox","bcp","minigame4","entities","enemy","MosaicosGroup"];
com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.prototype = {
	free: function() {
		if(this.mMosaico_1 != null) this.mMosaico_1.free();
		if(this.mMosaico_2 != null) this.mMosaico_2.free();
		if(this.mMosaico_3 != null) this.mMosaico_3.free();
	...
	,appearNextMosaico: function() {
		this.mMosaicoCount++;
		if(this.mMosaicoCount == 2) {
			var mx_1 = this.mMosaico_1.getX() + this.mMosaico_1.getWidth() - this.mMosaico_1.getWidth() / 4;
			this.mEffectManager.createEffect(mx_1,this.mY,"spMinigame04_ani_effect_puff","spMinigame04_ani_effect_puff");
			this.mMosaico_2 = new com.funbox.bcp.minigame4.entities.BaseActor("spMinigame04_mosaico_2_stand","spMinigame04_mosaico_2_stand",this.mMosaicoCanvas_2,mx_1,this.mY);
			this.mMosaico_2.getCharacter().addState("spMinigame04_mosaico_2_walk_left","spMinigame04_mosaico_2_walk_left","spMinigame04_mosaico_2_walk_left",-4,-7);
			this.mMosaico_2.getCharacter().addState("spMinigame04_mosaico_2_walk_right","spMinigame04_mosaico_2_walk_right","spMinigame04_mosaico_2_walk_right",7,-7);
			this.mMosaico_2.getCharacter().onEndAnimationCallback($bind(this,this.onEndAnimationMosaico_2));
		} else if(this.mMosaicoCount == 3) {
			var mx_2 = this.mMosaico_2.getX() + this.mMosaico_2.getWidth() - this.mMosaico_2.getWidth() / 4;
			this.mEffectManager.createEffect(mx_2,this.mY,"spMinigame04_ani_effect_puff","spMinigame04_ani_effect_puff");
			this.mMosaico_3 = new com.funbox.bcp.minigame4.entities.BaseActor("spMinigame04_mosaico_3_stand","spMinigame04_mosaico_3_stand",this.mMosaicoCanvas_1,mx_2,this.mY);
			this.mMosaico_3.getCharacter().addState("spMinigame04_mosaico_3_walk_left","spMinigame04_mosaico_3_walk_left","spMinigame04_mosaico_3_walk_left",-4,-7);
			this.mMosaico_3.getCharacter().addState("spMinigame04_mosaico_3_walk_right","spMinigame04_mosaico_3_walk_right","spMinigame04_mosaico_3_walk_right",7,-7);
			this.mMosaico_3.getCharacter().onEndAnimationCallback($bind(this,this.onEndAnimationMosaico_3));
		}
	}
	,gotoState: function(stateIdentifier) {
		var newState_1 = "";
		var newState_2 = "";
		var newState_3 = "";
		switch(stateIdentifier) {
		case com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.ST_STAND:
		...
		if(this.mMosaico_1 != null) this.mMosaico_1.getCharacter().gotoState(newState_1);
		if(this.mMosaico_2 != null) this.mMosaico_2.getCharacter().gotoState(newState_2);
		if(this.mMosaico_3 != null) this.mMosaico_3.getCharacter().gotoState(newState_3);
	}
	,onEndAnimationMosaico_3: function() {
		switch(this.mMosaico_3.getCharacter().currentState()) {
		case "spMinigame04_mosaico_3_walk_left":
			this.mMosaico_3.getCharacter().gotoState("spMinigame04_mosaico_3_stand");
			break;
	...
	,onEndAnimationMosaico_2: function() {
		switch(this.mMosaico_2.getCharacter().currentState()) {
		case "spMinigame04_mosaico_2_walk_left":
			this.mMosaico_2.getCharacter().gotoState("spMinigame04_mosaico_2_stand");
			break;
	...
	,onEndAnimationMosaico_1: function() {
		switch(this.mMosaico_1.getCharacter().currentState()) {
...
com.funbox.bcp.minigame4.entities.player = {}
com.funbox.bcp.minigame4.entities.player.GamePlayer = function(canvas,x,y,offsetX,offsetY) {
	if(offsetY == null) offsetY = 0;
	if(offsetX == null) offsetX = 0;
	com.funbox.bcp.minigame4.entities.BaseActor.call(this,"spMinigame04_player_stand","spMinigame04_player_stand",canvas,x,y);
	this.mCharacter.addState("spMinigame04_player_walk_right","spMinigame04_player_walk_left","spMinigame04_player_walk_left",3,-3);
	this.mCharacter.addState("spMinigame04_player_walk_left","spMinigame04_player_walk_right","spMinigame04_player_walk_right",-7,-1);
	this.mCharacter.onEndAnimationCallback($bind(this,this.onEndAnimation));
	this.mOffsetX = offsetX;
	this.mOffsetY = offsetY;
};
$hxClasses["com.funbox.bcp.minigame4.entities.player.GamePlayer"] = com.funbox.bcp.minigame4.entities.player.GamePlayer;
com.funbox.bcp.minigame4.entities.player.GamePlayer.__name__ = ["com","funbox","bcp","minigame4","entities","player","GamePlayer"];
com.funbox.bcp.minigame4.entities.player.GamePlayer.__super__ = com.funbox.bcp.minigame4.entities.BaseActor;
com.funbox.bcp.minigame4.entities.player.GamePlayer.prototype = $extend(com.funbox.bcp.minigame4.entities.BaseActor.prototype,{
	free: function() {
		com.funbox.bcp.minigame4.entities.BaseActor.prototype.free.call(this);
	}
	,update: function(dt) {
		com.funbox.bcp.minigame4.entities.BaseActor.prototype.update.call(this,dt);
	}
	,gotoState: function(state) {
		this.mCharacter.gotoState(state);
	}
	,onEndAnimation: function() {
		switch(this.mCharacter.currentState()) {
		case "spMinigame04_player_walk_left":
			this.mCharacter.gotoState("spMinigame04_player_stand");
			break;
	...
	,__class__: com.funbox.bcp.minigame4.entities.player.GamePlayer
});
com.funbox.bcp.minigame4.screens = {}
com.funbox.bcp.minigame4.screens.GameHud = function(canvas) {
	this.mCanvas = canvas;
	var posY = 5;
	this.mPuntajeSprite = new com.funbox.bcp.minigame4.entities.BaseActor("spminigame04_background_score",null,this.mCanvas,5,posY);
	this.mTextFormat = new browser.text.TextFormat();
	this.mTextFormat.color = -1;
	this.mTextFormat.size = 15;
	this.mTextFormat.bold = true;
	this.mTextFormat.font = "calibri";
	this.mTF_Score = new browser.text.TextField();
	...
	this.mTF_Time = new browser.text.TextField();
...
$hxClasses["com.funbox.bcp.minigame4.screens.GameHud"] = com.funbox.bcp.minigame4.screens.GameHud;
com.funbox.bcp.minigame4.screens.GameHud.__name__ = ["com","funbox","bcp","minigame4","screens","GameHud"];
com.funbox.bcp.minigame4.screens.GameHud.prototype = {
	free: function() {
	...
	,SetTime: function(value) {
		this.mTime = value;
		this.mTF_Time.set_text(com.funbox.bcp.minigame4.util.NUtils.parseMillisecondsInClockFormat(this.mTime));
	}
	,SetScore: function(value) {
		this.mScore = value;
		this.mTF_Score.set_text(com.funbox.bcp.minigame4.util.NUtils.getDigitsByValue(this.mScore,7));
	}
	,GetScore: function() {
		return this.mScore;
	}
	,__class__: com.funbox.bcp.minigame4.screens.GameHud
}
com.minigloop.ui = {}
...
com.funbox.bcp.minigame4.screens.GameScreen = function(canvas) {
	com.minigloop.ui.Screen.call(this,canvas);
	com.funbox.bcp.minigame4.screens.GameScreen.instance = this;
	this.mGameCanvas = new browser.display.Sprite();
	...
	this._gameHud = new com.funbox.bcp.minigame4.screens.GameHud(this.mHudCanvas);
	this._game = new com.funbox.bcp.minigame4.MiniGame2(this.mGameCanvas,this._gameHud);
	this._gameTransition = new com.funbox.bcp.minigame4.screens.GameTransitionPopupScreen(this.mFrontCanvas,$bind(this,this.onFinishTransition));
	this.mPausedGame = true;
	this._gameHud.update(33);
	this._game.update(33);
};
$hxClasses["com.funbox.bcp.minigame4.screens.GameScreen"] = com.funbox.bcp.minigame4.screens.GameScreen;
com.funbox.bcp.minigame4.screens.GameScreen.__name__ = ["com","funbox","bcp","minigame4","screens","GameScreen"];
com.funbox.bcp.minigame4.screens.GameScreen.__super__ = com.minigloop.ui.Screen;
com.funbox.bcp.minigame4.screens.GameScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	destroy: function() {
	...
	,onFinishTransition: function() {
		com.minigloop.util.SoundManager.play("bgm_4",true);
	...
	,__class__: com.funbox.bcp.minigame4.screens.GameScreen
});
com.funbox.bcp.minigame4.screens.GameTransitionPopupScreen = function(canvas,onCallbackFunction) {
	this.mCanvas = canvas;
	this.mOnCallbackFunction = onCallbackFunction;
	this._img_1 = com.funbox.bcp.minigame4.util.NUtils.getAsset("spminigame04_gui_text_03");
	this._img_2 = com.funbox.bcp.minigame4.util.NUtils.getAsset("spminigame04_gui_text_02");
	this._img_3 = com.funbox.bcp.minigame4.util.NUtils.getAsset("spminigame04_gui_text_01");
	this._start = com.funbox.bcp.minigame4.util.NUtils.getAsset("spminigame04_gui_text_start");
	this._img_1.set_x(310);
	this._img_1.set_y(220);
	this._img_1.set_scaleX(0);
	this._img_2.set_x(310);
	this._img_2.set_y(220);
	this._img_2.set_scaleX(0);
	this._img_3.set_x(310);
	this._img_3.set_y(220);
	this._img_3.set_scaleX(0);
	this._start.set_x(180);
	this._start.set_y(220);
	this._start.set_scaleX(0);
	...
	this._scaleTweener = new com.funbox.bcp.minigame4.util.ScaleTweener(this._img_1,$bind(this,this.tween2));
	this._scaleTweener._factor = 0.1;
};
$hxClasses["com.funbox.bcp.minigame4.screens.GameTransitionPopupScreen"] = com.funbox.bcp.minigame4.screens.GameTransitionPopupScreen;
com.funbox.bcp.minigame4.screens.GameTransitionPopupScreen.__name__ = ["com","funbox","bcp","minigame4","screens","GameTransitionPopupScreen"];
com.funbox.bcp.minigame4.screens.GameTransitionPopupScreen.prototype = {
	free: function() {
	...
	,tweenStart: function() {
		this._scaleTweener = new com.funbox.bcp.minigame4.util.ScaleTweener(this._start,$bind(this,this.endTweens));
		this._scaleTweener._factor = 0.1;
	}
	,tween3: function() {
		this._scaleTweener = new com.funbox.bcp.minigame4.util.ScaleTweener(this._img_3,$bind(this,this.tweenStart));
		this._scaleTweener._factor = 0.1;
	}
	,tween2: function() {
		this._scaleTweener = new com.funbox.bcp.minigame4.util.ScaleTweener(this._img_2,$bind(this,this.tween3));
		this._scaleTweener._factor = 0.1;
	}
	,__class__: com.funbox.bcp.minigame4.screens.GameTransitionPopupScreen
}
com.funbox.bcp.minigame4.screens.PreloaderScreen = function(canvas) {
	com.minigloop.ui.Screen.call(this,canvas);
	...
	this.bg = null;
	this.loadas = null;
	com.funbox.bcp.minigame4.Global.stage = canvas.get_stage();
	com.funbox.bcp.minigame4.Global.StageWidth = 640;
	com.funbox.bcp.minigame4.Global.StageHeight = 480;
	...
	com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/loader/spMinigame04_guiloader.png","guiloader");
	com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/spMinigame04_bg.jpg","spminigame04_bg");
	com.minigloop.util.DataLoader.addData("images/minigame04/interfaces/loader/spMinigame04_guiloader.json","guiloader");
...
$hxClasses["com.funbox.bcp.minigame4.screens.PreloaderScreen"] = com.funbox.bcp.minigame4.screens.PreloaderScreen;
com.funbox.bcp.minigame4.screens.PreloaderScreen.__name__ = ["com","funbox","bcp","minigame4","screens","PreloaderScreen"];
com.funbox.bcp.minigame4.screens.PreloaderScreen.__super__ = com.minigloop.ui.Screen;
com.funbox.bcp.minigame4.screens.PreloaderScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	update: function(dt) {
		...
		if(this._isAssetsDownloaded && this._isDataDownloaded && this._isSoundsDownloaded) {
			...
			this._isLoadingReady = false;
			this.loadas.destroy();
			com.minigloop.ui.ScreenManager.getInstance().gotoScreen(com.funbox.bcp.minigame4.screens.TutorialScreen);
		}
	...
	,onLoadingLoaded: function() {
		this._canvas.addChild(com.minigloop.util.AssetsLoader.getAsset("spminigame04_bg"));
		...
		com.minigloop.util.SoundManager.addSound("sound/bgm_4.mp3","bgm_4");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/gui_text_tutorial_generic.png","gui_text_tutorial_generic");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/tutorial/spMinigame04_tutorial_bcp_card.png","spMinigame04_tutorial_bcp_card");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/tutorial/spMinigame04_tutorial_mosaico_1_walk_right.png","spMinigame04_tutorial_mosaico_1_walk_right");
		com.minigloop.util.DataLoader.addData("images/minigame04/interfaces/tutorial/spMinigame04_tutorial_mosaico_1_walk_right.json","spMinigame04_tutorial_mosaico_1_walk_right");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/tutorial/spMinigame04_tutorial_player_walk_left.png","spMinigame04_tutorial_player_walk_left");
		com.minigloop.util.DataLoader.addData("images/minigame04/interfaces/tutorial/spMinigame04_tutorial_player_walk_left.json","spMinigame04_tutorial_player_walk_left");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_1/spMinigame04_mosaico_1_stand.png","spMinigame04_mosaico_1_stand");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_1/spMinigame04_mosaico_1_stand.json","spMinigame04_mosaico_1_stand");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_1/spMinigame04_mosaico_1_walk_left.png","spMinigame04_mosaico_1_walk_left");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_1/spMinigame04_mosaico_1_walk_left.json","spMinigame04_mosaico_1_walk_left");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_1/spMinigame04_mosaico_1_walk_right.png","spMinigame04_mosaico_1_walk_right");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_1/spMinigame04_mosaico_1_walk_right.json","spMinigame04_mosaico_1_walk_right");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_2/spMinigame04_mosaico_2_stand.png","spMinigame04_mosaico_2_stand");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_2/spMinigame04_mosaico_2_stand.json","spMinigame04_mosaico_2_stand");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_2/spMinigame04_mosaico_2_walk_left.png","spMinigame04_mosaico_2_walk_left");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_2/spMinigame04_mosaico_2_walk_left.json","spMinigame04_mosaico_2_walk_left");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_2/spMinigame04_mosaico_2_walk_right.png","spMinigame04_mosaico_2_walk_right");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_2/spMinigame04_mosaico_2_walk_right.json","spMinigame04_mosaico_2_walk_right");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_3/spMinigame04_mosaico_3_stand.png","spMinigame04_mosaico_3_stand");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_3/spMinigame04_mosaico_3_stand.json","spMinigame04_mosaico_3_stand");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_3/spMinigame04_mosaico_3_walk_left.png","spMinigame04_mosaico_3_walk_left");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_3/spMinigame04_mosaico_3_walk_left.json","spMinigame04_mosaico_3_walk_left");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/enemies/mosaico_3/spMinigame04_mosaico_3_walk_right.png","spMinigame04_mosaico_3_walk_right");
		com.minigloop.util.DataLoader.addData("images/minigame04/enemies/mosaico_3/spMinigame04_mosaico_3_walk_right.json","spMinigame04_mosaico_3_walk_right");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/puff/spMinigame04_ani_effect_puff.png","spMinigame04_ani_effect_puff");
		com.minigloop.util.DataLoader.addData("images/minigame04/puff/spMinigame04_ani_effect_puff.json","spMinigame04_ani_effect_puff");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/card/spMinigame04_bcp_card.png","spMinigame04_bcp_card");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/player/spMinigame04_player_stand.png","spMinigame04_player_stand");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/player/spMinigame04_player_walk_left.png","spMinigame04_player_walk_left");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/player/spMinigame04_player_walk_right.png","spMinigame04_player_walk_right");
		com.minigloop.util.DataLoader.addData("images/minigame04/player/spMinigame04_player_stand.json","spMinigame04_player_stand");
		com.minigloop.util.DataLoader.addData("images/minigame04/player/spMinigame04_player_walk_left.json","spMinigame04_player_walk_left");
		com.minigloop.util.DataLoader.addData("images/minigame04/player/spMinigame04_player_walk_right.json","spMinigame04_player_walk_right");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/scorecard/btn_volver.png","volver");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/scorecard/btn_regresar.png","regresar");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/scorecard/gui_scorecard_twitter_over.png","twitter");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/scorecard/gui_scorecard_face_over.png","facebook");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/scorecard/minigame04_scorecard.png","scorecard");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/spMinigame04_bg.jpg","spminigame04_bg");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/spMinigame04_background_mask.png","spminigame04_background_mask");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/popup_start_sequence/spMinigame04_gui_text_01.png","spminigame04_gui_text_01");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/popup_start_sequence/spMinigame04_gui_text_02.png","spminigame04_gui_text_02");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/popup_start_sequence/spMinigame04_gui_text_03.png","spminigame04_gui_text_03");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/popup_start_sequence/spMinigame04_gui_text_start.png","spminigame04_gui_text_start");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/hud/spMinigame04_background_score.png","spminigame04_background_score");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/interfaces/tutorial/spMinigame04_tutorial_text.png","spminigame04_tutorial_text");
		com.minigloop.util.AssetsLoader.addAsset("images/minigame04/score_effect/spMinigame04_score_100.png","spMinigame04_score_100");
	...
	,onLoadingDataLoaded: function() {
		this._isLoadingDataLoaded = true;
		console.log("LOADING DATA LOADED");
	}
	,onLoadingAssetsLoaded: function() {
		this._isLoadingAssetsLoaded = true;
		console.log("LOADING ASSETS LOADED");
	}
	,__class__: com.funbox.bcp.minigame4.screens.PreloaderScreen
});
com.funbox.bcp.minigame4.screens.ScoreCardScreen = function(canvas) {
	com.minigloop.ui.Screen.call(this,canvas);
	...
	this._message.set_text("Hiciste " + com.funbox.bcp.minigame4.Global.totalPoints + " puntos mientras practicabas para prevenir este fraude.");
	this._message.set_width(800);
	this._message.set_height(400);
	this._message.multiline = true;
	this._message.set_x(55);
	this._message.set_y(200);
	this._message.setTextFormat(tf);
...
$hxClasses["com.funbox.bcp.minigame4.screens.ScoreCardScreen"] = com.funbox.bcp.minigame4.screens.ScoreCardScreen;
com.funbox.bcp.minigame4.screens.ScoreCardScreen.__name__ = ["com","funbox","bcp","minigame4","screens","ScoreCardScreen"];
com.funbox.bcp.minigame4.screens.ScoreCardScreen.__super__ = com.minigloop.ui.Screen;
com.funbox.bcp.minigame4.screens.ScoreCardScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	destroy: function() {
	...
	,onClick: function(e) {
		...
		if(e.stageX - js.Lib.document.getElementById("banner").offsetLeft > 280 && e.stageX - js.Lib.document.getElementById("banner").offsetLeft < 313) {
			if(e.stageY - js.Lib.document.getElementById("banner").offsetTop > 290 && e.stageY - js.Lib.document.getElementById("banner").offsetTop < 323) {
				...
				eval("postFacebook(" + com.funbox.bcp.minigame4.Global.totalPoints + ")");
			}
		}
		if(e.stageX - js.Lib.document.getElementById("banner").offsetLeft > 320 && e.stageX - js.Lib.document.getElementById("banner").offsetLeft < 353) {
			if(e.stageY - js.Lib.document.getElementById("banner").offsetTop > 290 && e.stageY - js.Lib.document.getElementById("banner").offsetTop < 323) {
				...
				eval("postTwitter(" + com.funbox.bcp.minigame4.Global.totalPoints + ")");
			}
		}
	}
	,onMove: function(e) {
	...
	,__class__: com.funbox.bcp.minigame4.screens.ScoreCardScreen
});
com.funbox.bcp.minigame4.screens.TutorialScreen = function(canvas) {
	com.minigloop.ui.Screen.call(this,canvas);
	...
	this.mCanvasTutoSprite = new browser.display.Sprite();
	...
	this.mTutorialSprite = new com.funbox.bcp.minigame4.entities.BaseActor("spminigame04_tutorial_text",null,this.mCanvasTutorial,0,0);
	this.mTutorialSprite.setX(com.funbox.bcp.minigame4.Global.StageWidth / 2 - this.mTutorialSprite.getWidth() / 2);
	this.mTutorialSprite.setY(com.funbox.bcp.minigame4.Global.StageHeight / 2 - this.mTutorialSprite.getHeight() / 2 - 20);
	this.mTutorialSprite.setAlpha(0.0);
	this.mCurrentState = com.funbox.bcp.minigame4.screens.TutorialScreen.STATE_SHOW_TUTORIAL;
	this.mClickOneWay = true;
	this.mClickToContiue = new com.funbox.bcp.minigame4.entities.BaseActor("gui_text_tutorial_generic",null,this.mCanvasTutorial,0,0);
	this.mClickToContiue.setX(com.funbox.bcp.minigame4.Global.StageWidth / 2 - this.mClickToContiue.getWidth() / 2);
	this.mClickToContiue.setY(com.funbox.bcp.minigame4.Global.StageHeight - this.mClickToContiue.getHeight() / 2 - 20);
...
$hxClasses["com.funbox.bcp.minigame4.screens.TutorialScreen"] = com.funbox.bcp.minigame4.screens.TutorialScreen;
com.funbox.bcp.minigame4.screens.TutorialScreen.__name__ = ["com","funbox","bcp","minigame4","screens","TutorialScreen"];
com.funbox.bcp.minigame4.screens.TutorialScreen.__super__ = com.minigloop.ui.Screen;
com.funbox.bcp.minigame4.screens.TutorialScreen.prototype = $extend(com.minigloop.ui.Screen.prototype,{
	destroy: function() {
		this.mBGSprite.free();
		this.mBGMaskSprite.free();
		this.mTutorialSprite.free();
		this.mEffectManager.free();
		this.mPlayerSprite.free();
		this.mCardSprite.free();
		this.mMosaicoSprite.free();
		...
		this._canvas.removeChild(this.mCanvasTutoSprite);
		this.mMosaicoSprite = null;
		this.mPlayerSprite = null;
		this.mCardSprite = null;
		this.mEffectManager = null;
		this.mBGSprite = null;
		this.mBGMaskSprite = null;
		this.mTutorialSprite = null;
		this.mInterval = null;
		this.mCanvasTutoSprite = null;
		com.minigloop.ui.Screen.prototype.destroy.call(this);
	}
	,update: function(dt) {
		...
		case com.funbox.bcp.minigame4.screens.TutorialScreen.STATE_WAIT:
			if(this.mInterval != null) this.mInterval.update(dt);
			break;
		case com.funbox.bcp.minigame4.screens.TutorialScreen.STATE_DISAPPEAR_TUTORIAL:
			if(this.mTutorialSprite.getAlpha() <= 0.0) {
				this.mTutorialSprite.setAlpha(0.0);
				this.onGoGame();
				this.mCurrentState = com.funbox.bcp.minigame4.screens.TutorialScreen.STATE_NOTHING;
...
com.funbox.bcp.minigame4.util = {}
com.funbox.bcp.minigame4.util.NCharacter = function(canvas,scale) {
...
$hxClasses["com.funbox.bcp.minigame4.util.NCharacter"] = com.funbox.bcp.minigame4.util.NCharacter;
com.funbox.bcp.minigame4.util.NCharacter.__name__ = ["com","funbox","bcp","minigame4","util","NCharacter"];
com.funbox.bcp.minigame4.util.NCharacter.prototype = {
	free: function() {
	...
	,addState: function(id,clipName,tileData,offsetX,offsetY) {
		...
		animation.position.x = this.mX;
		animation.position.y = this.mY;
	...
	,__class__: com.funbox.bcp.minigame4.util.NCharacter
}
com.funbox.bcp.minigame4.util.NInterval = function(callbackFunc,timeLimit) {
	this.mTimeCounter = 0;
	this.mTimeLimit = 0;
	this.mTimeCounter = 0;
...
$hxClasses["com.funbox.bcp.minigame4.util.NInterval"] = com.funbox.bcp.minigame4.util.NInterval;
com.funbox.bcp.minigame4.util.NInterval.__name__ = ["com","funbox","bcp","minigame4","util","NInterval"];
com.funbox.bcp.minigame4.util.NInterval.prototype = {
	free: function() {
		this.mCallbackFunc = null;
	}
	,update: function(dt) {
...
$hxClasses["com.funbox.bcp.minigame4.util.NUtils"] = com.funbox.bcp.minigame4.util.NUtils;
com.funbox.bcp.minigame4.util.NUtils.__name__ = ["com","funbox","bcp","minigame4","util","NUtils"];
com.funbox.bcp.minigame4.util.NUtils.getAsset = function(assetName) {
	var b = com.minigloop.util.AssetsLoader.getAsset(assetName);
	var bd = b.bitmapData.clone();
	bd.draw(b);
	return new browser.display.Bitmap(bd);
}
com.funbox.bcp.minigame4.util.NUtils.parseMillisecondsInClockFormat = function(milliseconds) {
	...
	var clockFormat = com.funbox.bcp.minigame4.util.NUtils.getDigitsByValue(minutesFloor,2) + ":" + com.funbox.bcp.minigame4.util.NUtils.getDigitsByValue(seconds,2);
	return clockFormat;
}
com.funbox.bcp.minigame4.util.NUtils.getDigitsByValue = function(value,num_digits) {
...
com.funbox.bcp.minigame4.util.NUtils.prototype = {
	__class__: com.funbox.bcp.minigame4.util.NUtils
}
com.funbox.bcp.minigame4.util.ScaleTweener = function(bitmap,__callback) {
	this._factor = 0.025;
	this._value = 0;
	this._t = 0;
	this._obj = bitmap;
...
$hxClasses["com.funbox.bcp.minigame4.util.ScaleTweener"] = com.funbox.bcp.minigame4.util.ScaleTweener;
com.funbox.bcp.minigame4.util.ScaleTweener.__name__ = ["com","funbox","bcp","minigame4","util","ScaleTweener"];
com.funbox.bcp.minigame4.util.ScaleTweener.prototype = {
	update: function(dt) {
	...
	,__class__: com.funbox.bcp.minigame4.util.ScaleTweener
}
...
com.minigloop.Engine.prototype = {
	update: function(dt) {
		com.minigloop.ui.ScreenManager.getInstance().update(dt);
	}
	,loop: function(e) {
	...
	,init: function() {
		...
		com.minigloop.ui.ScreenManager.getInstance().init(this._bufferCanvas);
		com.minigloop.ui.ScreenManager.getInstance().gotoScreen(this._gameClass);
...
com.minigloop.display.AtlasSprite = function(canvas,imgId,atlasId,align) {
	...
	var i;
	var _g1 = 0, _g = obj.frames.length;
	while(_g1 < _g) {
		var i1 = _g1++;
		var frame = obj.frames[i1];
		this._sourceWidth = frame.spriteSourceSize.w;
		this._sourceHeight = frame.spriteSourceSize.h;
		var src = com.minigloop.util.AssetsLoader.getAsset(imgId).bitmapData;
		var bmd = new browser.display.BitmapData(frame.sourceSize.w,frame.sourceSize.h,true,0);
		bmd.copyPixels(src,new browser.geom.Rectangle(frame.frame.x,frame.frame.y,frame.frame.w,frame.frame.h),new browser.geom.Point(frame.spriteSourceSize.x,frame.spriteSourceSize.y));
		var bm = new browser.display.Bitmap(bmd);
		this._frames.push(bm);
	}
	switch(align) {
	case "center":
		this._offsetX = -this._sourceWidth / 2;
		this._offsetY = -this._sourceHeight / 2;
		break;
	}
};
...
com.minigloop.display.AtlasSprite.prototype = $extend(com.minigloop.display.VisualObject.prototype,{
	...
	,currentHeight: function() {
		return this._frames[this._currentIndex].get_height();
	}
...
com.minigloop.input.Mouse.onMouseMove = function(e) {
	...
	com.minigloop.input.Mouse.position.x = e.localX;
	com.minigloop.input.Mouse.position.y = e.localY;
}
...
com.minigloop.ui.ScreenManager.__properties__ = {get_instance:"getInstance"}
com.minigloop.ui.ScreenManager.getInstance = function() {
	if(com.minigloop.ui.ScreenManager.instance == null) com.minigloop.ui.ScreenManager.instance = new com.minigloop.ui.ScreenManager();
	return com.minigloop.ui.ScreenManager.instance;
}
com.minigloop.ui.ScreenManager.prototype = {
	...
	,gotoScreen: function(screenClass) {
...
com.minigloop.util.AssetsLoader.getAsset = function(id) {
	...
	while(_g1 < _g) {
		var i1 = _g1++;
		if(com.minigloop.util.AssetsLoader._ids[i1] == id) return js.Boot.__cast(com.minigloop.util.AssetsLoader._loaders[i1].content , browser.display.Bitmap);
	}
	return null;
}
...
com.minigloop.util.DataLoader.addData = function(url,id) {
	com.minigloop.util.DataLoader._urls.push(url);
...
com.minigloop.util.SoundManager = function() {
};
$hxClasses["com.minigloop.util.SoundManager"] = com.minigloop.util.SoundManager;
com.minigloop.util.SoundManager.__name__ = ["com","minigloop","util","SoundManager"];
com.minigloop.util.SoundManager.init = function() {
	com.minigloop.util.SoundManager._urls = new Array();
	com.minigloop.util.SoundManager._ids = new Array();
	com.minigloop.util.SoundManager._sounds = new Array();
	com.minigloop.util.SoundManager._channels = new Array();
	com.minigloop.util.SoundManager._index = 0;
}
com.minigloop.util.SoundManager.addSound = function(url,id) {
	com.minigloop.util.SoundManager._urls.push(url);
	com.minigloop.util.SoundManager._ids.push(id);
}
com.minigloop.util.SoundManager.load = function(__callback) {
	com.minigloop.util.SoundManager._callback = __callback;
	com.minigloop.util.SoundManager.loadSound();
}
com.minigloop.util.SoundManager.loadSound = function(e) {
	if(com.minigloop.util.SoundManager._index < com.minigloop.util.SoundManager._urls.length) {
		var request = new browser.net.URLRequest(com.minigloop.util.SoundManager._urls[com.minigloop.util.SoundManager._index]);
...
com.minigloop.util.SoundManager.getSound = function(id) {
	var i;
	var _g1 = 0, _g = com.minigloop.util.SoundManager._urls.length;
	while(_g1 < _g) {
		var i1 = _g1++;
		if(com.minigloop.util.SoundManager._ids[i1] == id) return com.minigloop.util.SoundManager._sounds[i1];
	}
	return null;
}
com.minigloop.util.SoundManager.play = function(id,loop) {
...
com.minigloop.util.SoundManager.stopAll = function() {
	...
	while(_g1 < _g) {
		var i1 = _g1++;
		if(com.minigloop.util.SoundManager._channels[i1] != null) com.minigloop.util.SoundManager._channels[i1].stop();
...
com.funbox.bcp.minigame4.Global.StageWidth = 0;
com.funbox.bcp.minigame4.Global.StageHeight = 0;
com.funbox.bcp.minigame4.Global.totalPoints = 0;
com.funbox.bcp.minigame4.engine.PullAndPushController.WAVE_1 = 0;
com.funbox.bcp.minigame4.engine.PullAndPushController.WAVE_2 = 1;
com.funbox.bcp.minigame4.engine.PullAndPushController.WAVE_3 = 2;
com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.ST_STAND = 0;
com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.ST_WALK_RIGHT = 1;
com.funbox.bcp.minigame4.entities.enemy.MosaicosGroup.ST_WALK_LEFT = 2;
com.funbox.bcp.minigame4.screens.TutorialScreen.STATE_SHOW_TUTORIAL = 0;
com.funbox.bcp.minigame4.screens.TutorialScreen.STATE_WAIT = 1;
com.funbox.bcp.minigame4.screens.TutorialScreen.STATE_DISAPPEAR_TUTORIAL = 2;
com.funbox.bcp.minigame4.screens.TutorialScreen.STATE_NOTHING = 3;
